...
const styles = {
  ...
  btnTwo: `${genStyles.btn} ${genStyles.flexCenter} gap-3 py-4 hover:opacity-80 bg-white text-greenTheme `,
  btnThree: `${genStyles.btn} ${genStyles.flexCenter} gap-3 bg-greenTheme py-4 border-2 border-white text-white hover:opacity-80 hover:text-white`,
  ...
  imgContainer: `${genStyles.flexCenter} lg:h-auto lg:w-[50%] w-full relative lg:mt-0 md:mt-[10%] md:mb-0 mb-[30px] top-8 md:right-0  lg:translate-x-[10%] -translate-x-[10%]`,
