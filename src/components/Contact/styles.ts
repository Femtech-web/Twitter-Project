...
const styles = {
  ...
  inner_container: "flex lg:flex-row flex-col gap-[4rem] lg:items-center min-h-[70vh] md:p-4 ",
  input: `outline-none px-4 py-4 w-full bg-[#F5F5F5] rounded-lg focus:border-2 md:text-base text-sm placeholder:text-sm`,
  form: "flex flex-col gap-4 flex-1 bg-white rounded-lg min-h-[60vh] py-[3rem] sm:px-[2rem] text-slate-700 px-2",
